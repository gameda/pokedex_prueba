...
class GetFavoritePokemonsUseCase @Inject constructor(private val repository: PokedexRepository) {

    operator fun invoke():  Flow<List<SimplePokemon>> =
        repository.getPokemonsFavorites()
